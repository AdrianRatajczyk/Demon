...
#define SPIx_CS_MODE					GPIO_Mode_Out_PP
...
#define LSM9DS0_CS_XM_GPIO						GPIOA
#define LSM9DS0_CS_XM_PIN						GPIO_Pin_4
#define LSM9DS0_CS_XM_MODE 						GPIO_Mode_Out_PP

#define LSM9DS0_CS_G_GPIO						GPIOA
#define LSM9DS0_CS_G_PIN						GPIO_Pin_8
